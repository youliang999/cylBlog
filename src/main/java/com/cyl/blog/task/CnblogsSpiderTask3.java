 ...
 */
public class CnblogsSpiderTask3 {
    private static final Logger log = LoggerFactory.getLogger(CnblogsSpiderTask3.class);
    ...
    private static CnblogsSpiderTask3 instance = new CnblogsSpiderTask3();
    ...
    public static CnblogsSpiderTask3 getInstance() {
        return instance;
    }
    ...
    private void startCrawler() {
                    ...
                    try {
                        for (int i = 1; i <= 200; i++) {
                            String ajaxUrl = "";
                            if(i<=1) {
                                    ajaxUrl = "https://www.cnblogs.com/cate/mysql/";
                            } else { //106876   108696
                                ajaxUrl = "https://www.cnblogs.com/mvc/AggSite/PostList.aspx" + "?CategoryId=108715&CategoryType=SiteCategory&ItemListActionName=PostList&ParentCategoryId=108712&TotalPostCount=2904&PageIndex=" + i;
                            }
...
//        }
        ...
        try {
            Thread.sleep(10000);
            ConcurrentLinkedQueue<BlogVo> queue =  (ConcurrentLinkedQueue<BlogVo>) MySpiderUtil.deserializeObject("src/main/resources/cnblogs-proxies-mysql)");
        ...
        if (entity != null) {
            ...
            for (Element element : elements) {
                ...
                if (nickNames.contains(author) || realNames.contains(author)) {
                    ...
                    if("Leo-Yang".equals(author) || "Ray Liang".equals(author) || "东方".equals(filterEmoji(author)) || "骨月枫".equals(filterEmoji(author)) || author.contains("翻墙的小哲")) {                        return;
                    }
