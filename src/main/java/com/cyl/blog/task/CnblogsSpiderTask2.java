 ...
 */
public class CnblogsSpiderTask2 {
    private static final Logger log = LoggerFactory.getLogger(CnblogsSpiderTask2.class);
    ...
    private static CnblogsSpiderTask2 instance = new CnblogsSpiderTask2();
    ...
    public static CnblogsSpiderTask2 getInstance() {
        return instance;
    }
    ...
    private void startCrawler() {
                    ...
                    try {
                        for (int i = 1; i <= 200; i++) {
                            String ajaxUrl = "";
                            if(i<=1) {
                                    ajaxUrl = "https://www.cnblogs.com/cate/nosql/";
                            } else { //106876   108696
                                ajaxUrl = "https://www.cnblogs.com/mvc/AggSite/PostList.aspx" + "?CategoryId=108743&CategoryType=SiteCategory&ItemListActionName=PostList&ParentCategoryId=108712&TotalPostCount=551&PageIndex=" + i;
                            }
...
//
         MySpiderUtil.serializeObject(spiderQueue, "src/main/resources/cnblogs-proxies-nosql)");
...
//        }
        ...
        try {
            Thread.sleep(10000);
            ConcurrentLinkedQueue<BlogVo> queue =  (ConcurrentLinkedQueue<BlogVo>) MySpiderUtil.deserializeObject("src/main/resources/cnblogs-proxies-nosql)");
        ...
        if (entity != null) {
            ...
            for (Element element : elements) {
                ...
                if (nickNames.contains(author) || realNames.contains(author)) {
                    ...
                    if("Leo-Yang".equals(author) || "Ray Liang".equals(author) || "东方".equals(filterEmoji(author)) || "骨月枫".equals(filterEmoji(author)) || author.contains("翻墙的小哲")) {
                        return;
                    }
