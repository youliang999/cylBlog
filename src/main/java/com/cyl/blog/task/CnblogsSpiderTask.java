 ...
 */
public class CnblogsSpiderTask {
    private static final Logger log = LoggerFactory.getLogger(CnblogsSpiderTask.class);
    ...
    private static CnblogsSpiderTask instance = new CnblogsSpiderTask();
    ...
    public static CnblogsSpiderTask getInstance() {
        return instance;
    }
    ...
    private void startCrawler() {
                    ...
                    try {
                        for (int i = 1; i <= 200; i++) {
                            String ajaxUrl = "";
                            if(i<=1) {
                                    ajaxUrl = "https://www.cnblogs.com/cate/linux/";
                            } else { //106876   108696
                                ajaxUrl = "https://www.cnblogs.com/mvc/AggSite/PostList.aspx" + "?CategoryId=108726&CategoryType=SiteCategory&ItemListActionName=PostList&ParentCategoryId=108724&TotalPostCount=4000&PageIndex=" + i;
                            }
...
//
         MySpiderUtil.serializeObject(spiderQueue, "src/main/resources/cnblogs-proxies-linux)");
...
//        }
        ...
        try {
            Thread.sleep(10000);
            ConcurrentLinkedQueue<BlogVo> queue =  (ConcurrentLinkedQueue<BlogVo>) MySpiderUtil.deserializeObject("src/main/resources/cnblogs-proxies-linux)");
...
//                    new String(Base64.getEncoder().encode(str.getBytes()), "UTF-8");
