...
function dTree(objName) {
	...
	this.icon = {
		root				: '/resource/authtree/img/base.gif',
		folder			: '/resource/authtree/img/folder.gif',
		folderOpen	: '/resource/authtree/img/folderopen.gif',
		node				: '/resource/authtree/img/page.gif',
		empty				: '/resource/authtree/img/empty.gif',
		line				: '/resource/authtree/img/line.gif',
		join				: '/resource/authtree/img/join.gif',
		joinBottom	: '/resource/authtree/img/joinbottom.gif',
		plus				: '/resource/authtree/img/plus.gif',
		plusBottom	: '/resource/authtree/img/plusbottom.gif',
		minus				: '/resource/authtree/img/minus.gif',
		minusBottom	: '/resource/authtree/img/minusbottom.gif',
		nlPlus			: '/resource/authtree/img/nolines_plus.gif',
		nlMinus			: '/resource/authtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
