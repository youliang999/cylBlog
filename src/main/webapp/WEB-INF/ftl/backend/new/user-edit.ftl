        ...
        <div class="panel-body">
            <form action="." method="post" class="form-horizontal text-left" role="form">
                ...
                <div class="form-group <#if form?? && form.nickName != "">has-error</#if>">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="nickName" value="${user.nickName!}" <#if user??>readonly</#if>/>
                ...
                <div class="form-group <#if form?? && form.password!="">has-error</#if>">
                    ...
                    <div class="col-sm-6">
                        ...
                        <#if user!=null><p class="help-block">如果您想修改您的密码，请在此输入新密码。不然请留空</p></#if>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" name="role">
                            <option value="contributor" <#if user.role =='contributor'>selected = 'selected'</#if>>投稿者</option>
                            <option value="editor" <#if user.role=='editor'>selected = 'selected'</#if>>编辑</option>
                            <option value="admin" <#if user.role=='admin'>selected = 'selected'</#if>>管理员</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
