            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">设置 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <#--<dl id="menu-picture">-->
            ...
            <#--<dd>-->
                <#--<ul>-->
                    ...
                    <#--&lt;#&ndash;<li><a data-href="${g.domain}/backend/blog/notepad" data-title="发布博客(notepad)" href="javascript:void(0)">发布博客(notepad)</a></li>&ndash;&gt;-->
        ...
        <#--<dl id="menu-product">-->
            ...
            <#--</dd>-->
        <#--</dl>-->
        <#--&lt;#&ndash;<dl id="menu-comments">&ndash;&gt;-->
            <#--&lt;#&ndash;<dt><i class="Hui-iconfont">&#xe622;</i> 页面<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>&ndash;&gt;-->
            <#--&lt;#&ndash;<dd>&ndash;&gt;-->
                <#--&lt;#&ndash;<ul>&ndash;&gt;-->
                    <#--&lt;#&ndash;<li><a data-href="http://h-ui.duoshuo.com/admin/" data-title="所有页面" href="javascript:;">所有页面</a></li>&ndash;&gt;-->
                    <#--&lt;#&ndash;<li><a data-href="feedback-list.html" data-title="新建页面" href="javascript:void(0)">新建页面</a></li>&ndash;&gt;-->
                <#--&lt;#&ndash;</ul>&ndash;&gt;-->
            <#--&lt;#&ndash;</dd>&ndash;&gt;-->
        <#--&lt;#&ndash;</dl>&ndash;&gt;-->
        <#--<dl id="menu-member">-->
        ...
        <#--<dl id="menu-system">-->
            ...
            <#--<dd>-->
                <#--<ul>-->
                    ...
                    <#--&lt;#&ndash;<li><a data-href="${g.domain}/backend/tool/import" data-title="导入" href="javascript:void(0)">导入</a></li>&ndash;&gt;-->
                    <#--&lt;#&ndash;<li><a data-href="${g.domain}/backend/tool/output" data-title="导出" href="javascript:void(0)">导出</a></li>&ndash;&gt;-->
                <#--</ul>-->
            <#--</dd>-->
        <#--</dl>-->
        ...
        <#--<dl id="menu-system">-->
            ...
            <#--<dd>-->
                <#--<ul>-->
                    <#--<li><a data-href="${g.domain}/backend/auth/tree" id="redisLook" data-title="所有权限" href="javascript:void(0)">所有权限</a></li>-->
                    <#--<li><a data-title="增加菜单" href="${g.domain}/backend/auth/addMenu" target="_blank">增加菜单</a></li>-->
                <#--</ul>-->
            <#--</dd>-->
        <#--</dl>-->
    </div>
