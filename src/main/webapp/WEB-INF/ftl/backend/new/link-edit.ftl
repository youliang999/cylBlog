            ...
            <form action="." method="post" class="form-horizontal text-left" role="form">
                ...
                <div class="form-group <#if form?? &&  form.name!=null>has-error</#if>">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="help-block"><#if form?? && form.name!=null>${form.name!}<#else>例如：好用的博客软件</#if></p>
                    </div>
                </div>
                <div class="form-group <#if form?? && form.url!=null>has-error</#if>">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="help-block"><#if form?? && form.url!=null>${form.url!}<#else>不要忘了http://</#if></p>
                    </div>
                </div>
